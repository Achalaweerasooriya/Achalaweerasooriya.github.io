...
<head>
    ...
    <!-- Morris Charts CSS -->
    <link href="http://localhost/css/plugins/morris.css" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="http://localhost/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
...
<body>
                    ...
                    <div class="col-lg-12">
                       ...
                       <h3>Edit Users</h3>  
                            <div id="infoMessage"><?php echo $message;?></div>
                               ...
                               <?php echo form_open("ManageUser_Controller/edit_user/$user_id");?>
                               <div class="table-responsive">
                                    <table class="table table-bordered table-hover" table width="700" border="0" cellpadding="0" cellspacing="2" align="center">
                                    <div class="form-group">
                                        ...
                                        <tr>
                                            ...
                                            echo form_dropdown('designation', $option,$designation['value']);?>                                   
                                            </td>            		
                                        </tr>            		
                                        <tr>
                                            <td>&nbsp;</td>
                                            <td><?php echo form_submit('submit', 'Submit');?>
                                                    <input type="button" class="btn btn-primary"name="btnBack" id="btnBack" value="Back" onclick="window.location.href='<?php echo base_url() ?>ManageUser_Controller/view_users'" />
                                            </td>
                                        </tr>                              
                                    </table>
                                    <?php echo form_close(); ?>                
    ...
    <script src="http://localhost/js/plugins/morris/raphael.min.js"></script>
    <script src="http://localhost/js/plugins/morris/morris.min.js"></script>
    <script src="http://localhost/js/plugins/morris/morris-data.js"></script>
