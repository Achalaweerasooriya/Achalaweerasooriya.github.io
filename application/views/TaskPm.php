...
<head>
    ...
    <!-- Custom Fonts -->
    <link href="http://localhost/ci3/ci/admin/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    ...
    <div id="wrapper">
		...
		?>
			<tr >
				...
				<td id="id1"  width="12%"><?php  $val3 = $t['status']; echo $val3 ?> <br>
                                <td>  <?php     if ($val3 == "Done") {
                                            echo '-';
                                        }
                                        else{?>
               ...
               <a href=<?php echo base_url()."PmTask_Controller/edit_task_pm/"?><?php echo $taskid ?>><strong>Edit</strong></a></td>
                                        <?php }?>       </tr>
