                            ...
                            <div class="panel-body">                                                                                                                                
                              <form method="POST" action="add_task">
                                ...
                                <div class="form-group">
                                    <label>Task</label><br/>
                                    <?php echo form_textarea('task', set_value('task','')); ?>
                                        <font color="#ff0000"><?php echo form_error('task'); ?></font>
                                </div>                              
                                ...
                                ?>
                                    ...
                                    <form enctype="multipart/form-data" action="upload_files" method="post">
    
                                        <input type="file" name="myuploader" id="myuploader1"><br/>
                                        <input type="submit" name="submit" value="Submit">
                                    </form>
                              <input type="button" class="btn btn-primary"name="btnView" id="btnBack" value="View Tasks" onclick="window.location.href='<?php echo base_url().'PmTask_Controller/view_tasks'?>'" />
                            </div>
